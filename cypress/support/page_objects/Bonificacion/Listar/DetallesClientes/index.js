...
class BonificacionListarDetallesClientes {
    ...
    clickarBotonVolver() {
     ...
     clickarResultadosVerDetallesInterrupciones() {
        ...
        cy.intercept('GET', '**/credit/interruptionsdetaillistbonificationdefinitive?**').as('ultimoRequest');
...
export default new BonificacionListarDetallesClientes();